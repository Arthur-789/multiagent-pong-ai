...
- **Mutação**: flip bit com probabilidade de ~1/12288 por bit (~0,5 bit esperado por indivíduo mutado após a redução do cromossomo), taxa de 30% por indivíduo (padrão)
...
escalar com a matriz de pesos. As 3 saídas resultantes correspondem ao espaço
de ações compartilhado com o RL (`FIRE`, `FIRE_RIGHT`, `FIRE_LEFT`), sendo
escolhida a de maior pontuação e convertida para os códigos de ação `1`, `4` e
`5` do ambiente.
