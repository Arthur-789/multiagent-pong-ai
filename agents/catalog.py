...
from core.config import CAMINHO_MELHOR_CHECKPOINT, GA_CAMINHO_CHECKPOINT
...
def carregar_agente(tipo, agente_id):
    if tipo == "rl":
        ...
        from agents.rl_agent import AgenteRL
    ...
    if tipo == "genetico":
        ...
        import numpy as np
        from agents.genetic_agent import AgenteGenetico
